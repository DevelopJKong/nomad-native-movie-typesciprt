...
import { Dimensions, StyleSheet, Linking, View, Text, TouchableOpacity } from "react-native";
...
const Detail: React.FC<DetailScreenProps> = ({ navigation: { setOptions }, route: { params } }) => {
    ...
    const openYLink = async (videoID: any) => {
        ...
        <Container>
            ...
            <Data>
                ...
                {data?.videos?.results?.map((video: any) => (
                    <VideoBtn key={video.key} onPress={openYLink}>
